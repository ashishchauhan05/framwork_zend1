...
! function(t) {
    ...
    a.prototype = {
        ...
        handleRequests: function() {
            ...
            for (var o in this.requests) this.requests.hasOwnProperty(o) && (this.requests[o].isDuplicated || ! function(o, n) {
                if ("function" == typeof e.options.source[o].ajax) {
                    ...
                    if (n = e.extendXhrObject(e.generateRequestObject(o), "object" == typeof s ? s : {}), "object" != typeof n.request || !n.request.url) return void e.populateSource([], o);
                    e.requests[o] = n
                }
                var r, a, l = !1;
                if (~n.request.url.indexOf("{{query}}") && (l || (n = t.extend(!0, {}, n), l = !0), n.request.url = n.request.url.replace("{{query}}", encodeURIComponent(e.query))), n.request.data)
                    for (var h in n.request.data)
                        if (n.request.data.hasOwnProperty(h) && ~String(n.request.data[h]).indexOf("{{query}}")) {
                            l || (n = t.extend(!0, {}, n), l = !0), n.request.data[h] = n.request.data[h].replace("{{query}}", e.query);
                            break
                        }
                t.ajax(n.request).done(function(t, i, o) {
                    a = null;
                    for (var s = 0, l = n.validForGroup.length; l > s; s++) r = e.requests[n.validForGroup[s]], r.callback.done instanceof Function && (a = r.callback.done(t, i, o))
                }).fail(function(t, i, o) {
                    ...
                    for (var l = 0, h = n.validForGroup.length; h > l; l++) r = e.requests[n.validForGroup[l]], r.callback.always instanceof Function && r.callback.always(t, o, s), e.populateSource("function" == typeof t.promise && [] || a || t, r.extra.group, r.extra.path || r.request.path), i -= 1, 0 === i && e.helper.executeCallback.call(e, e.options.callback.onReceiveRequest, [e.node, e.query])
                }).then(function(t, i) {
        ...
        populateSource: function(t, e, i) {
            ...
            for (var r, a = n.display ? "compiled" === n.display[0] ? n.display[1] : n.display[0] : "compiled" === this.options.display[0] ? this.options.display[1] : this.options.display[0], l = 0, h = t.length; h > l; l++) null !== t[l] && "boolean" != typeof t[l] && ("string" == typeof t[l] && (r = {}, r[a] = t[l], t[l] = r), t[l].group = e);
            if (!this.options.dynamic && this.dropdownFilter.dynamic.length)
                for (var u, p, c = {}, l = 0, h = t.length; h > l; l++)
                    for (var d = 0, f = this.dropdownFilter.dynamic.length; f > d; d++) u = this.dropdownFilter.dynamic[d].key, p = t[l][u], p && (this.dropdownFilter.dynamic[d].value || (this.dropdownFilter.dynamic[d].value = []), c[u] || (c[u] = []), ~c[u].indexOf(p.toLowerCase()) || (c[u].push(p.toLowerCase()), this.dropdownFilter.dynamic[d].value.push(p)));
        ...
        searchResultData: function() {
            var t, e, i, o, n, s, r, a, l, h, u, p, c, d = this,
                f = this.groupBy,
                y = null,
        ...
        buildHtmlLayout: function() {
            if (this.options.resultContainer !== !1) {
                ...
                this.groupTemplate ? n = t(n.replace(/<([^>]+)>\{\{(.+?)}}<\/[^>]+>/g, function(t, i, n, r, a) {
                    ...
                    for (var u = 0, p = h.length; p > u; ++u) l += "<" + i + ' data-group-template="' + h[u] + '"><ul></ul></' + i + ">";
                    return l
                ...
                for (var r, a, l, h, u, p, c, d, f, y, g, m = this.groupTemplate && this.result.length && o.groups || [], v = 0, b = this.result.length; b > v; ++v) l = this.result[v], r = l.group, h = this.options.source[l.group].href || this.options.href, d = [], f = this.options.source[l.group].display || this.options.display, this.options.group && (r = l[this.options.group.key], this.options.group.template && ("function" == typeof this.options.group.template ? a = this.options.group.template(l) : "string" == typeof this.options.template && (a = this.options.group.template.replace(/\{\{([\w\-\.]+)}}/gi, function(t, e) {
                        ...
                        "data-search-group": r
                    }))), this.groupTemplate && m.length && (g = m.indexOf(r || l.group), ~g && m.splice(g, 1)), u = t("<li/>", {
                        ...
                        html: t("<a/>", {
                            ...
                            "data-index": v,
                            html: function() {
                                if (p = l.group && o.options.source[l.group].template || o.options.template) "function" == typeof p && (p = p.call(o, o.query, l)), c = p.replace(/\{\{([^\|}]+)(?:\|([^}]+))*}}/gi, function(t, e, n) {
                                    ...
                                    c = '<span class="' + o.options.selector.display + '">' + o.helper.cleanStringFromScript(String(d.join(" "))) + "</span>"
                                }(o.options.highlight === !0 && i && !p || "any" === o.options.highlight) && (c = o.helper.highlight.call(o, c, i.split(" "), o.options.accent)), t(this).append(c)
                            }
                        })
                    }),
                    function(e, i, n) {
                    ...
                    }(v, l, u), (this.groupTemplate ? n.find('[data-group-template="' + r + '"] ul') : n).append(u);
                    ...
                    if (this.hint.container || (this.hint.css = t.extend({
                        ...
                        for (var s, r, a, l = 0, h = e.length; h > l; l++) {
                            ...
                            for (var u = 0, p = s.length; p > u; u++)
                                if (a = String(e[l][s[u]]).toLowerCase(), this.options.accent && (a = this.helper.removeAccent.call(this, a)), 0 === a.indexOf(n)) {
                                    o = String(e[l][s[u]]), this.hintIndex = l;
                                    break
                                }
        ...
        buildDropdownItemLayout: function(e) {
            function i(t) {
                "*" === t.value ? delete this.filters.dropdown : this.filters.dropdown = t, this.container.removeClass("filter").find("." + this.options.selector.filterButton).html(t.template), this.isDropdownEvent = !0, this.node.trigger("dynamic" + this.namespace), this.node.focus()
            }
            var o, n, s = this,
            ...
            for (var l = 0, h = this.dropdownFilter[e].length; h > l; l++) {
                ...
                for (var u = 0, p = n.value.length; p >= u; u++)(u !== p || l === h - 1) && (u === p && l === h - 1 && "static" === e && this.dropdownFilter.dynamic.length || (o = this.dropdownFilterAll || r, n.value[u] ? o = n.template ? n.template.replace(new RegExp("{{" + n.key + "}}", "gi"), n.value[u]) : n.value[u] : this.container.find("." + s.options.selector.filterButton).html(o), function(e, o, n) {
                    a.append(t("<li/>", {
        ...
        dynamicFilter: {
            ...
            getValue: function(t) {
                var e;
                return "SELECT" === t.tagName ? e = t.value : "INPUT" === t.tagName && ("checkbox" === t.type ? e = t.checked && t.getAttribute("value") || t.checked || null : "radio" === t.type && t.checked && (e = t.value)),
                    e
            }
        },
        showLayout: function() {
